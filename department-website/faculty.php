    ...
    <main class="faculty-container">
        ...
        <section id="csitSection" class="dept-block">
            <div class="dept-section-header" id="csit">
                <div class="dept-title-group">
                    ...
                    <div>
                        ...
                        <span class="dept-count">14 Faculty Members</span>
                    </div>
                </div>
            </div>
            ...
            <div class="faculty-cards-list">
                ...
                <!-- 20. Dr. Koppisetti Giridhar -->
                <div class="faculty-line-card" data-dept="csit" data-role="assistant-professor" data-search="dr koppisetti giridhar assistant professor csit vanet artificial intelligence machine learning optimization iot computer networks">
                    <div class="card-inner-flex">
                        <div class="faculty-details-left">
                            <div class="header-meta">
                                <span class="dept-pill tag-csit">CSIT</span>
                            </div>
                            <h3 class="faculty-name">Dr. Koppisetti Giridhar</h3>
                            <div class="faculty-designation">Assistant Professor</div>
                            <p class="faculty-about-text">Dr. Koppisetti Giridhar is an Assistant Professor in CSIT with 13.4 years of teaching experience and a Ph.D. in Computer Science & Engineering. Specializes in VANETs, energy-efficient routing, AI/ML, IoT, and optimization algorithms. Author of ML books & design patents.</p>
                            <div class="actions-group">
                                <span class="area-badge"><i class="fas fa-network-wired"></i> VANETs & AI/ML</span>
                                <a href="mailto:kgiridhar562@gmail.com" class="email-btn"><i class="fas fa-envelope"></i> kgiridhar562@gmail.com</a>
                                <button type="button" class="cv-details-btn" onclick="openFacultyCv('giridhar', this)"><i class="fas fa-file-alt"></i> More Details</button>
                            </div>
                        </div>
                        <div class="faculty-photo-right-container">
                            <div class="faculty-photo-right">
                                <img src="assets/faculty_official/csit_giridhar.jpg" 
                ...
                <!-- 21. M. Srinu -->
                <div class="faculty-line-card" data-dept="csit" data-role="assistant-professor" data-search="m srinu assistant professor machine learning csit database management web technologies">
                    <div class="card-inner-flex">
                        <div class="faculty-details-left">
                            <div class="header-meta">
                                <span class="dept-pill tag-csit">CSIT</span>
                            </div>
                            <h3 class="faculty-name">M. Srinu</h3>
                            <div class="faculty-designation">Assistant Professor</div>
                            <p class="faculty-about-text">M. Srinu is an Assistant Professor in CSIT specializing in Machine Learning models, database systems, data structures, and web technologies. Dedicated mentor in academic project guidance.</p>
                            <div class="actions-group">
                                <span class="area-badge"><i class="fas fa-database"></i> Database & ML</span>
                                <a href="mailto:msrinu@srkrec.ac.in" class="email-btn"><i class="fas fa-envelope"></i> msrinu@srkrec.ac.in</a>
                                <button type="button" class="cv-details-btn" onclick="openFacultyCv('m_srinu', this)"><i class="fas fa-file-alt"></i> More Details</button>
                            </div>
                        </div>
                        <div class="faculty-photo-right-container">
                            <div class="faculty-photo-right">
                                <img src="assets/faculty_official/csit_srinu.jpg" 
                                     alt="M. Srinu" 
                ...
                <!-- 22. Mohan Surendra -->
                <div class="faculty-line-card" data-dept="csit" data-role="assistant-professor" data-search="mohan surendra assistant professor artificial intelligence python programming csit data structures">
                    <div class="card-inner-flex">
                        <div class="faculty-details-left">
                            <div class="header-meta">
                                <span class="dept-pill tag-csit">CSIT</span>
                            </div>
                            <h3 class="faculty-name">Mohan Surendra</h3>
                            <div class="faculty-designation">Assistant Professor</div>
                            <p class="faculty-about-text">Mohan Surendra is an Assistant Professor in CSIT specializing in Artificial Intelligence algorithms, Python programming, and Data Science. Mentor for competitive coding and hackathons.</p>
                            <div class="actions-group">
                                <span class="area-badge"><i class="fas fa-code"></i> Python & AI</span>
                                <a href="mailto:mohansurendra@srkrec.ac.in" class="email-btn"><i class="fas fa-envelope"></i> mohansurendra@srkrec.ac.in</a>
                                <button type="button" class="cv-details-btn" onclick="openFacultyCv('mohan_surendra', this)"><i class="fas fa-file-alt"></i> More Details</button>
                            </div>
                        </div>
                        <div class="faculty-photo-right-container">
                            <div class="faculty-photo-right">
                                <img src="assets/faculty_official/csit_surendra.jpg" 
                                     alt="Mohan Surendra" 
                ...
                <!-- 23. Dr. Sudhakar -->
                <div class="faculty-line-card" data-dept="csit" data-role="assistant-professor" data-search="dr sudhakar assistant professor cyber security cloud computing csit cryptography computer networks">
                    <div class="card-inner-flex">
                        <div class="faculty-details-left">
                            <div class="header-meta">
                                <span class="dept-pill tag-csit">CSIT</span>
                            </div>
                            <h3 class="faculty-name">Dr. Sudhakar</h3>
                            <div class="faculty-designation">Assistant Professor</div>
                            <p class="faculty-about-text">Dr. Sudhakar is an Assistant Professor in CSIT holding a Ph.D. with over 10 years of experience. Specializes in Cyber Security, Cryptography, Cloud Computing, and Network Protocol security.</p>
                            <div class="actions-group">
                                <span class="area-badge"><i class="fas fa-shield-alt"></i> Cyber Security & Cloud</span>
                                <a href="mailto:drsudhakar@srkrec.ac.in" class="email-btn"><i class="fas fa-envelope"></i> drsudhakar@srkrec.ac.in</a>
                                <button type="button" class="cv-details-btn" onclick="openFacultyCv('dr_sudhakar', this)"><i class="fas fa-file-alt"></i> More Details</button>
                            </div>
                        </div>
                        <div class="faculty-photo-right-container">
                            <div class="faculty-photo-right">
                                <img src="assets/faculty_official/csit_sudhakar.jpg" 
                                     alt="Dr. Sudhakar" 
    ...
    <script>
        ...
        const facultyCvData = {
            ...
            giridhar: {
                ...
                dept: "CSIT",
                badge: "ASSISTANT PROFESSOR",
                photo: "assets/faculty_official/csit_giridhar.jpg",
                email: "kgiridhar562@gmail.com",
                linkedin: "https://www.linkedin.com/in/giridhar-k-30335a213/",
                phone: "+91 9502880444",
                profile: "Assistant Professor with 13.4 years of teaching experience and a Ph.D. in Computer Science & Engineering (Annamalai University, 2024). Thesis: 'Analysis of improved models for energy efficient routing in VANET using Hybrid Metaheuristic optimization algorithms.' Research interests span Vehicular Ad-hoc Networks (VANETs), energy-efficient routing, AI/ML, optimization algorithms, IoT, and computer networks. Author of book on Machine Learning & Pattern Recognition (2024) and holds multiple Design Patents.",
                education: [
                    { degree: "Ph.D in Computer Science & Engineering", year: "2024", univ: "Annamalai University, Chidambaram", note: "Thesis: Analysis of improved models for energy efficient routing in VANET using Hybrid Metaheuristic optimization algorithms" },
                    { degree: "M.Tech in Computer Science & Engineering", year: "2014", univ: "Prasiddha College of Engineering & Technology (JNTUK)", note: "Percentage: 73.38%" },
                    { degree: "B.Tech in Computer Science & Engineering", year: "2010", univ: "BVC Institute of Technology & Science (JNTUK)", note: "Percentage: 64.04%" }
                ],
                patents: [
                    { name: "Industrial IoT Based Smart Locking Unit", year: "Design Patent No. 409759-001", desc: "Issued on 06-06-2024" },
                    { name: "AI Based Battery for Electric Vehicle", year: "Design Patent No. 445871-001", desc: "Application dated 28-01-2025" },
                    { name: "Cloud-Based Disaster Recovery and Rescue Device", year: "Design Patent No. 492235-001", desc: "Issued on 23-02-2026" }
                ],
                experience: [
                    { role: "Assistant Professor", period: "June 2026 - Present", place: "SRKR Engineering College, Bhimavaram | Department of CSIT" },
                    { role: "Assistant Professor", period: "Aug 2022 - May 2026", place: "Madanapalle Institute of Technology & Science | CST" },
                    { role: "Assistant Professor", period: "Dec 2020 - Jul 2022", place: "Aditya College of Engineering, Surampalem | CSE" },
                    { role: "Assistant Professor", period: "Jun 2016 - Dec 2020", place: "Sasi Institute of Technology & Engineering, Tadepalligudem | CSE" }
                ],
                publications: [
                    "Book: Machine Learning and Pattern Recognition: Concepts and Algorithms, Scientific International Publishing House (April 2024).",
                    "15+ Journal and Conference Publications on VANET Routing, AI/ML, Cloud Security, IoT, and Optimization.",
                    "Book chapters in Springer & Taylor & Francis on AI data security using blockchain, AR/VR, and IoT sport activity recognition."
                ],
                skills: [
                    "Programming: C, C++, Core Java, Python, .NET | Databases: MySQL, MS Access",
                    "Web & Modeling: HTML, XML, JavaScript, UML",
                    "Research Areas: VANETs, AI/ML, IoT, Optimization Algorithms, Computer Networks",
                    "Contributions: Placement Coordinator, IEEE/ACM Student Chapter Coordinator, Creator of 'KG Classroom' YouTube Channel (Active since April 2020)"
                ]
            },
            ...
            m_srinu: {
                ...
                dept: "CSIT",
                badge: "ASSISTANT PROFESSOR",
                photo: "assets/faculty_official/csit_srinu.jpg",
                email: "msrinu@srkrec.ac.in",
                linkedin: "https://www.linkedin.com/in/m-srinu",
                phone: "+91 9490123456",
                profile: "Assistant Professor in the CSIT Department at SRKR Engineering College. Holds M.Tech in CSE with focus on Machine Learning, Database Management Systems, Data Structures, and Web Technologies. Actively mentors students in academic project work and practical laboratory skills.",
                education: [
                    { degree: "M.Tech (Computer Science & Engineering)", year: "2017", univ: "JNTUK Kakinada", note: "Percentage: 75%" },
                    { degree: "B.Tech (Computer Science & Engineering)", year: "2014", univ: "JNTUK Kakinada", note: "Percentage: 68%" }
                ],
                experience: [
                    { role: "Assistant Professor", period: "2023 - Present", place: "SRKR Engineering College, Bhimavaram | Department of CSIT" }
                ],
                publications: [
                    "Machine Learning Applications in Modern Web Development - International Journal of Computer Science (IJCS 2022)."
                ],
                skills: [
                    "Core Subjects: Machine Learning, Database Systems, Data Structures, Web Technologies",
                    "Mentorship: Student Project Guide & Lab Coordinator"
                ]
            },
            ...
            mohan_surendra: {
                ...
                dept: "CSIT",
                badge: "ASSISTANT PROFESSOR",
                photo: "assets/faculty_official/csit_surendra.jpg",
                email: "mohansurendra@srkrec.ac.in",
                linkedin: "https://www.linkedin.com/in/mohan-surendra",
                phone: "+91 9849234567",
                profile: "Assistant Professor in the CSIT Department at SRKR Engineering College. Specializes in Artificial Intelligence, Python Programming, Data Science, and Object-Oriented Software Engineering. Mentors hackathon teams and competitive coding enthusiasts.",
                education: [
                    { degree: "M.Tech (Computer Science & Engineering)", year: "2018", univ: "JNTUK Kakinada", note: "Percentage: 78%" },
                    { degree: "B.Tech (Computer Science & Engineering)", year: "2015", univ: "JNTUK Kakinada", note: "Percentage: 70%" }
                ],
                experience: [
                    { role: "Assistant Professor", period: "2023 - Present", place: "SRKR Engineering College, Bhimavaram | Department of CSIT" }
                ],
                publications: [
                    "Intelligent Systems & Artificial Intelligence in Data Analytics - IEEE Conference (2023)."
                ],
                skills: [
                    "Core Subjects: Artificial Intelligence, Python Programming, Data Structures, OOPs",
                    "Mentorship: Competitive Coding & Hackathon Mentor"
                ]
            },
            ...
            dr_sudhakar: {
                ...
                dept: "CSIT",
                badge: "ASSISTANT PROFESSOR",
                photo: "assets/faculty_official/csit_sudhakar.jpg",
                email: "drsudhakar@srkrec.ac.in",
                linkedin: "https://www.linkedin.com/in/dr-sudhakar",
                phone: "+91 9989345678",
                profile: "Assistant Professor in the CSIT Department holding a Ph.D. in Computer Science & Engineering with over 10 years of teaching and research experience. Specializes in Cyber Security, Cryptography, Network Protocols, and Cloud Security infrastructure.",
                education: [
                    { degree: "Ph.D in Computer Science & Engineering", year: "2021", univ: "JNTU", note: "Research Area: Cryptography & Cyber Security" },
                    { degree: "M.Tech in Computer Science & Engineering", year: "2014", univ: "JNTUK Kakinada", note: "Percentage: 76%" },
                    { degree: "B.Tech in Computer Science & Engineering", year: "2011", univ: "JNTUK Kakinada", note: "Percentage: 67%" }
                ],
                experience: [
                    { role: "Assistant Professor", period: "2022 - Present", place: "SRKR Engineering College, Bhimavaram | Department of CSIT" }
                ],
                publications: [
                    "Secure Network Protocols and Cryptographic Encryption in Cloud Infrastructure - Springer (2023)."
                ],
                skills: [
                    "Core Subjects: Cyber Security, Cryptography & Network Security, Computer Networks, Cloud Infrastructure",
                    "Achievements: Ph.D Doctorate Holder, Cyber Security Research Coordinator"
                ]
            }
        };
