...
<body>
    ...
    <section class="hero-section">
        ...
        <script>
        (function() {
            var v = document.getElementById('startupHeroVideo');
            if (!v) return;
            v.muted = true;
            function tryPlay() {
        ...
        <?php else: ?>
        <!-- PRODUCTION: YouTube background video (ID: _6FW9VKbPeM) -->
        <div id="startupYTPlayerWrap" style="pointer-events:none;">
            <div class="yt-touch-shield"></div>
            <iframe id="startupYTPlayer"
                    src="https://www.youtube.com/embed/_6FW9VKbPeM?autoplay=1&mute=1&loop=1&playlist=_6FW9VKbPeM&controls=0&showinfo=0&rel=0&playsinline=1&enablejsapi=1&modestbranding=1&iv_load_policy=3&disablekb=1"
                    title="Startup Club Background"
                    frameborder="0"
        ...
        <style>
            ...
            #startupYTPlayerWrap iframe.yt-playing {
                opacity: 1 !important;
            }
        </style>
        <script>
                    ...
                    events: {
                        ...
                        onStateChange: function(e) {
                            if (e.data === YT.PlayerState.PLAYING) {
                                var el = document.getElementById('startupYTPlayer');
