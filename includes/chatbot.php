 ...
 */
?>
<!-- Chatbot Stylesheet (named dept-assistant.css to bypass InfinityFree's "chatbot" filename block) -->
<link rel="stylesheet" href="assets/css/dept-assistant.css">
...
<!-- Chatbot JavaScript Services (renamed to bypass InfinityFree "chatbot" filename block) -->
<script src="assets/js/deptAssistantService.js"></script>
<script src="assets/js/deptAssistantUI.js"></script>
