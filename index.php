...
<style>
    ...
    /* Relative positioning for full responsiveness */
    .house-agni { top: 14%; left: 50%; }
    .house-vayu { top: 38.9%; left: 84.2%; }
    .house-prudhvi { top: 79.1%; left: 71.2%; }
    .house-jal { top: 79.1%; left: 28.8%; }
    .house-aakash { top: 38.9%; left: 15.8%; }
    ...
    /* Mobile tweaks for the hero section */
    @media (max-width: 768px) {
...
<body>
    ...
    <section class="premium-hero-section">
        ...
        <div class="hero-background">
            ...
            <?php else: ?>
            <!-- PRODUCTION: YouTube background video (ID: wg0wjB3AAWM) -->
            <div id="heroYTPlayerWrap" style="pointer-events:none;">
                <div class="yt-touch-shield"></div>
                <iframe id="heroYTPlayer"
                        src="https://www.youtube.com/embed/wg0wjB3AAWM?autoplay=1&mute=1&loop=1&playlist=wg0wjB3AAWM&controls=0&showinfo=0&rel=0&playsinline=1&enablejsapi=1&modestbranding=1&iv_load_policy=3&disablekb=1"
                        title="Department Hero Background"
                        frameborder="0"
            ...
            <style>
                ...
                #heroYTPlayerWrap iframe.yt-playing {
                    opacity: 1 !important;
                }
            </style>
            <script>
                        ...
                        events: {
                            ...
                            onStateChange: function(e) {
                                if (e.data === YT.PlayerState.PLAYING) {
                                    var el = document.getElementById('heroYTPlayer');
    ...
    <section class="company-partners-section" style="padding: 60px 0 80px; position: relative; z-index: 50; background: #ffffff;">
        <div class="container">
            ...
            <div class="companies-carousel-wrapper" style="overflow: hidden; ">
                ...
                <div class="carousel-row" style="display: flex; animation: scroll-right 30s linear infinite; ">
                    ...
                    <div class="company-item">
                        <img src="./assets/company_logos/logos/12.png?v=2" class="company-logo-meeami" alt="Meeami Technologies">
                    </div>
                    <div class="company-item">
            ...
            <style>
                ...
                .company-item img.company-logo-meeami,
                .company-item img[src*="12.png"] {
    ...
    <section class="hero-section" style="flex: 1; padding: 150px; margin-top: -180px;">
        <div class="hero-content">
            ...
            <div class="hero-buttons" style="pointer-events: auto !important; position: relative; z-index: 9999 !important;">
                <a href="houses_dashboard.php" class="btn btn-primary" style="position: relative; z-index: 9999;">
                    <i class="fas fa-trophy"></i> House Activities </a>
                <a href="heroes_of_department.php" class="btn" style="background: #7c3aed; color: white; position: relative; z-index: 9999; cursor: pointer;">
                    <i class="fas fa-user-shield me-1"></i> Class Representatives
                </a>
                <a href="students_overview.php" class="btn" style="background: #f1f5f9; color: #475569; position: relative; z-index: 9999;">
                    Students Overview
                </a>
            </div>
        </div>
        ...
        <section class="houses-section" style="flex: 1;">
            <div class="houses-container">
                ...
                <div class="houses-orbit-ring">
                    ...
                    <a href="house_detail.php?house=Agni" class="house-item house-agni" style="cursor: pointer; text-decoration: none; z-index: 100;">
